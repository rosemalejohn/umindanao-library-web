...
var _index = require('./components/courses/index.vue');

var _index2 = _interopRequireDefault(_index);

var _index3 = require('./components/colleges/index.vue');

var _index4 = _interopRequireDefault(_index3);

var _ResourceListings = require('./components/ResourceListings.vue');

var _ResourceListings2 = _interopRequireDefault(_ResourceListings);

var _ShowResource = require('./components/ShowResource.vue');

var _ShowResource2 = _interopRequireDefault(_ShowResource);
...
var _Course = require('./forms/Course.vue');

var _Course2 = _interopRequireDefault(_Course);

var _College = require('./forms/College.vue');

var _College2 = _interopRequireDefault(_College);

var _Resources = require('./forms/Resources.vue');
...
exports.default = {
	...
	components: {
		CoursesListings: _index2.default,
		CollegesListings: _index4.default,
		ResourceListings: _ResourceListings2.default,
		ShowResource: _ShowResource2.default,
		Dashboard: _Dashboard2.default,

		CourseFormModal: _Modal2.default,
		CollegeFormModal: _Modal2.default,
		ResourceFormModal: _Modal2.default,

		CourseForm: _Course2.default,
		CollegeForm: _College2.default,
		ResourceForm: _Resources2.default
	},
	...
	ready: function ready() {
		...
		memberChannel.bind('App\\Events\\NewMemberRegistered', function (message) {
			toastr.success('New member registered: ' + message.member.full_name);
			_this.$emit('member:created', message.member);
		});

		resourceChannel.bind('App\\Events\\NewResourceVisit', function (message) {
			var resource = member.resource;
			toastr.success('New user visited the ' + resource.name);
			_this.$emit('resource:visit', resource);
		});
	},
	...
	events: {
		'college:created': function collegeCreated(college) {
			this.$broadcast('college:created', college);
		},
		'resource:created': function resourceCreated(resource) {
			this.$broadcast('resource:created', resource);
		},
		'resource:visit': function resourceVisit(resource) {
			this.$broadcast('resource:visit', resource);
		},
		'course:created': function courseCreated(course) {
			this.$broadcast('course:created', course);
		},
		'member:created': function memberCreated(member) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-02f0e342", module.exports)
  } else {
    hotAPI.update("_v-02f0e342", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./components/Dashboard.vue":19,"./components/Modal.vue":20,"./components/ResourceListings.vue":22,"./components/ShowResource.vue":23,"./components/colleges/index.vue":24,"./components/courses/index.vue":25,"./forms/College.vue":26,"./forms/Course.vue":27,"./forms/Resources.vue":28,"moment":1,"vue":15,"vue-hot-reload-api":13}],18:[function(require,module,exports){
'use strict';
...
},{"./App.vue":17,"vue":15,"vue-resource":14}],19:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	methods: {
		getMembers: function getMembers() {
			...
			this.$http.get('members').then(function (response) {
				...
				_this.members = _this.paginator.data;
				_this.data = _this.members;
			});
		},
		next: function next() {
			var _this2 = this;

			this.$http.get(this.paginator.next_page_url).then(function (response) {
				_this2.paginator = response.data;
				_this2.members = _this2.paginator.data;
				_this2.data = _this2.members;
			});
		},
		previous: function previous() {
			var _this3 = this;

			this.$http.get(this.paginator.prev_page_url).then(function (response) {
				_this3.paginator = response.data;
				_this3.members = _this3.paginator.data;
				_this3.data = _this3.members;
			});
		},
		remove: function remove(member) {
			...
			swal({
				...
				if (isConfirm) {
					self.$http.delete('members/' + member.id).then(function (response) {
	...
	computed: {
		students: function students() {
			return _underscore2.default.where(this.members, { type: 'student' });
		},
		faculties: function faculties() {
			return _underscore2.default.where(this.members, { type: 'faculty' });
		},
		filterMembersBy: function filterMembersBy(filter) {
			this.members = _underscore2.default.filter(this.members, function (member) {
				var date = (0, _moment2.default)().subtract(1, filter);

				return (0, _moment2.default)(date).isAfter(member.created_at);
			});
		}
	},
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-aca7b33a", module.exports)
  } else {
    hotAPI.update("_v-aca7b33a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":15,"vue-hot-reload-api":13}],21:[function(require,module,exports){
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-c36f75ee", module.exports)
  } else {
    hotAPI.update("_v-c36f75ee", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":15,"vue-hot-reload-api":13,"vueify/lib/insert-css":16}],22:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	components: {
		EditResourceFormModal: _Modal2.default, ResourceForm: _Resources2.default
	},
	...
	methods: {
		getResources: function getResources() {
			...
			this.$http.get('resources').then(function (response) {
		...
		remove: function remove(resource) {
			...
			swal({
				...
				if (isConfirm) {
					self.$http.delete('resources/' + resource.id).then(function (response) {
		...
		updateResources: function updateResources() {
			this.$http.put('resources/' + this.resource.id, this.resource).then(function (response) {
...
exports.default = {
	...
	methods: {
		filterBy: function filterBy(filter) {
			this.data = _underscore2.default.filter(this.resource.visitors, function (visitor) {
				return (0, _moment2.default)(visitor.pivot.created_at) >= (0, _moment2.default)().startOf(filter);
			});
		}
	},
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-d0d2d436", module.exports)
  } else {
    hotAPI.update("_v-d0d2d436", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"moment":1,"underscore":12,"vue":15,"vue-hot-reload-api":13}],24:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	methods: {
		getColleges: function getColleges() {
			...
			this.$http.get('colleges').then(function (response) {
				_this.colleges = response.data;
			});
		},
		remove: function remove(college) {
			var self = this;
			(0, _sweetalert2.default)({
				...
				if (isConfirm) {
					self.$http.delete('colleges/' + college.id).then(function (response) {
						self.colleges.$remove(college);
						(0, _sweetalert2.default)("Deleted!", "Your imaginary file has been deleted.", "success");
					});
				} else {
					(0, _sweetalert2.default)("Cancelled", "College is not deleted :)", "error");
				}
			});
		}
	},
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"row\">\n\t<div class=\"col-md-12\">\n\t\t<div class=\"portlet light\">\n\t\t\t<div class=\"portlet-title\">\n\t\t\t\t<div class=\"caption caption-md font-red-sunglo\">\n\t\t\t\t\t<i class=\"icon-bar-chart theme-font hide\"></i>\n\t\t\t\t\t<span class=\"caption-subject theme-font bold uppercase\">Colleges</span>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class=\"portlet-body\">\n\t\t\t\t<div class=\"table-scrollable table-scrollable-borderless\">\n\t\t\t\t\t<table class=\"table table-hover table-light\">\n\t\t\t\t\t<thead>\n\t\t\t\t\t<tr class=\"uppercase\">\n\t\t\t\t\t\t<th>\n\t\t\t\t\t\t\tNAME\n\t\t\t\t\t\t</th>\n\t\t\t\t\t\t<th>\n\t\t\t\t\t\t\tDATE CREATED\n\t\t\t\t\t\t</th>\n\t\t\t\t\t\t<th>\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t</th>\n\t\t\t\t\t</tr>\n\t\t\t\t\t</thead>\n\t\t\t\t\t\t<tbody><tr v-for=\"college in colleges\">\n\t\t\t\t\t\t\t<td>\n\t\t\t\t\t\t\t\t{{ college.name }}\n\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t<td>\n\t\t\t\t\t\t\t\t{{ college.created_at | date 'relative' }}\n\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t<td>\n\t\t\t\t\t\t\t\t<button @click=\"remove(college)\" class=\"btn btn-danger btn-sm\"><i class=\"fa fa-remove\"></i></button>\n\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t</tbody></table>\n\t\t\t\t\t<div v-if=\"!colleges.length\" class=\"alert alert-info\">No members registered!</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2e611bd9", module.exports)
  } else {
    hotAPI.update("_v-2e611bd9", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"sweetalert":11,"vue":15,"vue-hot-reload-api":13}],25:[function(require,module,exports){
"use strict";
  ...
  methods: {
    ...
    remove: function remove(course) {
      ...
      swal({
        ...
        if (isConfirm) {
          self.$http.delete('courses/' + course.id).then(function (response) {
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"row\">\n\t<div class=\"col-md-12\">\n\t\t<div class=\"portlet light\">\n\t\t\t<div class=\"portlet-title\">\n\t\t\t\t<div class=\"caption caption-md font-red-sunglo\">\n\t\t\t\t\t<i class=\"icon-bar-chart theme-font hide\"></i>\n\t\t\t\t\t<span class=\"caption-subject theme-font bold uppercase\">Courses</span>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class=\"portlet-body\">\n\t\t\t\t<div class=\"table-scrollable table-scrollable-borderless\">\n\t\t\t\t\t<table class=\"table table-hover table-light\">\n\t\t\t\t\t<thead>\n\t\t\t\t\t<tr class=\"uppercase\">\n\t\t\t\t\t\t<th>\n\t\t\t\t\t\t\tNAME\n\t\t\t\t\t\t</th>\n\t\t\t\t\t\t<th>\n\t\t\t\t\t\t\tCOLLEGE\n\t\t\t\t\t\t</th>\n\t\t\t\t\t\t<th>\n\t\t\t\t\t\t\tDATE CREATED\n\t\t\t\t\t\t</th>\n\t\t\t\t\t\t<th>\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t</th>\n\t\t\t\t\t</tr>\n\t\t\t\t\t</thead>\n\t\t\t\t\t\t<tbody><tr v-for=\"course in courses\">\n\t\t\t\t\t\t\t<td>\n\t\t\t\t\t\t\t\t{{ course.name }}\n\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t<td>\n\t\t\t\t\t\t\t\t{{ course.college.name }}\n\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t<td>\n\t\t\t\t\t\t\t\t{{ course.created_at | date 'relative' }}\n\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t<td>\n\t\t\t\t\t\t\t\t<button @click=\"remove(course)\" class=\"btn btn-danger btn-sm\"><i class=\"fa fa-remove\"></i></button>\n\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t</tbody></table>\n\t\t\t\t\t<div v-if=\"!courses.length\" class=\"alert alert-info\">No course registered!</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-d566c2de", module.exports)
  } else {
    hotAPI.update("_v-d566c2de", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":15,"vue-hot-reload-api":13}],26:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        submit: function submit() {
            ...
            this.$http.post('colleges', this.form).then(function (response) {
                _this.form = {};
                toastr.success('College: ' + response.data.name + ' added.');
                _this.$dispatch('college:created', response.data);
            });
        }
    },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-efb3aad0", module.exports)
  } else {
    hotAPI.update("_v-efb3aad0", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":15,"vue-hot-reload-api":13}],27:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        submit: function submit() {
            ...
            this.$http.post('courses', this.form).then(function (response) {
                _this2.colleges = response.data;
                _this2.$dispatch('course:created', response.data);
                _this2.form.code = '';
                _this2.form.name = '';
            });
        }
    ...
    events: {
        'form:submit': function formSubmit(val) {
            if (val == 'course') {
                this.submit();
            }
        }
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-0fbc1bac", module.exports)
  } else {
    hotAPI.update("_v-0fbc1bac", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":15,"vue-hot-reload-api":13}],28:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        submit: function submit() {
            ...
            this.$http.post('resources', this.form).then(function (response) {
                toastr.success('Resources added!');
                _this.form = {};
                _this.$dispatch('resource:created', response.data);
            }).catch(function (err) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-61d7b9e6", module.exports)
  } else {
    hotAPI.update("_v-61d7b9e6", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./../components/PhotoUpload.vue":21,"vue":15,"vue-hot-reload-api":13}]},{},[18]);
